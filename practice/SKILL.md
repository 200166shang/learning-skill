...
Practice can write only PracticeTask, PracticeAttempt, and practice Evidence. It cannot write Learning State, Journey, Episode/Question status, ReviewItem, or Review schedule. A failure may lead you to suggest another practice, review, or a new learning Episode, but none starts automatically.
